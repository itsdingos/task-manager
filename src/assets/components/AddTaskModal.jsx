    ...
    <div className="fixed bg-black/50 flex items-center justify-center inset-0">
      <div className="bg-white rounded-lg shadow-md p-6 w-96 mx-auto mt-20">
        ...
        <form onSubmit={handleSubmit}>
          <label htmlFor="taskName" className="block text-gray-600">{t('addTask.taskName')}</label>
          ...
          <label htmlFor="description" className="block text-gray-600 mt-4">{t('addTask.taskDescription')}</label>
          <input type="text" name="description" id="description" className="border border-gray-300 rounded-md py-2 px-3 mt-2 focus:outline-none focus:ring-2 focus:ring-blue-500" placeholder={t('addTask.optional')} />

          <div className="flex items-center mt-4 gap-x-4">
            <div>
              <label htmlFor="dueDate" className="block text-gray-600 mt-4">{t('addTask.dueDate')}</label>
